...
)
{
    ...
    _private_dynamic_array_init(old_header->stride, old_header->allocator, capacity, &new_array);
    if (new_array == nullptr)
    {
        // Return if allocation of the new one fails.
        return;
    }
...
)
{
    ...
    *new_array = (void*)((unsigned char*)(*new_array) + header_size);
...
)
{
    ...
    {
        _private_dynamic_array_resize(array, 0);
